...
const Profile = () => {
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 bg-gray-50/50 dark:bg-gray-950/50 relative overflow-hidden">
            <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-teal-200/20 rounded-full blur-[120px]" />
            <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-purple-200/20 rounded-full blur-[120px]" />
            ...
            <div className="max-w-2xl mx-auto px-4 sm:px-6 relative">
                ...
                <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden">
                    ...
                    <div className="px-8 pb-8 -mt-12 text-center">
                        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 border-4 border-white dark:border-gray-900 flex items-center justify-center text-white font-bold text-3xl mx-auto shadow-lg">
                            D
                        </div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-4">Demo User</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Free Plan</p>

                        <div className="mt-8 space-y-3 text-left">
                            {details.map((item) => (
                                <div key={item.label} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
                                    <div className="flex items-center gap-3">
                                        <div className="w-9 h-9 rounded-lg bg-white dark:bg-gray-700 shadow-sm flex items-center justify-center text-teal-600 dark:text-teal-400">
