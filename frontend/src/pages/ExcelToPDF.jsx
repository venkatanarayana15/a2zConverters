...
const ExcelToPDF = () => {
    ...
    const handleConvert = async () => {
        ...
        try {
            const result = await apiPost('/api/v1/pdf/excel-to-pdf', makeUploadForm(file, {}, 'file'));
        ...
        <div className="min-h-screen pt-24 px-4 pb-12 bg-gray-50 text-gray-900">
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-emerald-500">
                    ...
                    {!file ? (
                        <div className="border-2 border-dashed border-gray-200 rounded-xl p-16 hover:bg-gray-50 transition-colors">
                            ...
                            <label htmlFor="excel-upload" className="cursor-pointer">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Select EXCEL file</h3>
                                <p className="text-sm text-gray-500">or drop XLS/XLSX here</p>
                            </label>
                        </div>
                    ) : (
                        <div className="py-10">
