        ...
        <div className="min-h-screen pt-24 px-4 pb-12 bg-background text-foreground">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12 animate-float">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-500 to-violet-500">
                        PDF Validator
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="glass-card p-8 rounded-2xl relative overflow-hidden group md:col-span-2 lg:col-span-1">
                        ...
                        <div className={`border-2 border-dashed rounded-xl p-8 text-center transition-all duration-300 ${file ? 'border-blue-500 bg-blue-50' : 'border-gray-300 hover:border-blue-400 hover:bg-blue-50/50'}`}>
                            <input
                                type="file"
                                id="pdf-upload"
                                className="hidden"
                            ...
                            <label htmlFor="pdf-upload" className="cursor-pointer w-full h-full flex flex-col items-center justify-center">
                                {file ? (
                                    ...
                                    <>
                                        <div className="w-16 h-16 bg-white border border-gray-100 shadow-sm rounded-full flex items-center justify-center mb-4 text-gray-400 group-hover:scale-110 group-hover:text-blue-500 transition-all duration-300">
                                            <Upload className="w-8 h-8" />
                                        </div>
                                        <span className="text-gray-900 font-medium">Click to upload PDF</span>
                                        <span className="text-sm text-gray-500 mt-2">PDF documents only</span>
                                    </>
                                )}
                            </label>
                        </div>
                            ...
                            <div className="animate-fade-in">
                                ...
                                <div className="space-y-3">
                                    {validationResult.details.map((detail, idx) => (
                                        <div key={idx} className="flex items-center p-3 bg-white/50 rounded-lg border border-gray-100">
