    ...
    return (
        <div className="min-h-screen pt-24 px-2 md:px-4 pb-12 bg-background text-foreground">
            <div className="max-w-[96rem] mx-auto">
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 min-h-[400px] dark:bg-gray-900 dark:border-gray-800">
                    {files.length === 0 ? (
                        <div className="h-full border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center p-12 hover:bg-gray-50 transition-colors dark:border-gray-700 dark:hover:bg-gray-800">
                            ...
                            <label htmlFor="upload" className="cursor-pointer text-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2 dark:text-gray-100">Drop JPGs here</h3>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                                {files.map((file, i) => (
                                    <motion.div
                                        ...
                                        className="relative aspect-[3/4] bg-gray-100 rounded-xl overflow-hidden shadow-sm dark:bg-gray-800"
                                    >
                                        <img src={file.preview} alt={file.name} className="w-full h-full object-cover" />
                                    </motion.div>
                                ))}
                                <div className="aspect-[3/4] border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center hover:bg-gray-50 cursor-pointer dark:border-gray-700 dark:hover:bg-gray-800">
