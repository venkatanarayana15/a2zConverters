    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1.5">~1.2 MB used of 10 MB estimated</p>
            </div>
            <div>
            ...
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Auto-Delete Files</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Automatically clear processed files</p>
                </div>
                <button onClick={() => onChange('autoDelete', !autoDelete)} className={cn(toggleClass, autoDelete ? 'bg-blue-600' : 'bg-gray-300 dark:bg-gray-600')}>
