    ...
    <div className="space-y-6">
        <div className="flex items-center justify-between">
            <div>
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400">Switch to a darker theme</p>
            </div>
            <button onClick={() => onChange('darkMode', !darkMode)} className={cn(toggleClass, darkMode ? 'bg-blue-600' : 'bg-gray-300 dark:bg-slate-600')}>
        ...
        <div>
            <p className="text-sm font-medium text-gray-900 dark:text-slate-100 mb-3">Accent Color</p>
